...
import {p} from 'src/_old/app/shared.styles';
import {IndicatorsComponent} from 'src/_old/components/indicators/indicators.component';
import {LoadingComponent} from 'src/_old/components/loading/loading.component';
import {usePlayerContext} from 'src/_old/contexts/player-context';
import {WebGlComponent} from 'src/_old/modules/player/components/artwork/web-gl.component';
