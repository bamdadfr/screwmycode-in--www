...
describe ('AudioTitleComponent', () => {
    ...
    describe ('container', () => {
        ...
        it ('should be in the document', () => {
            ...
            const { container } = render (<PlayerTitleComponent title="title"/>)
    ...
    describe ('title', () => {
        ...
        it ('should be in the document', () => {
            ...
            render (<PlayerTitleComponent title="title"/>)
        ...
        it ('should display props.title', () => {
            ...
            render (<PlayerTitleComponent title={value}/>)
